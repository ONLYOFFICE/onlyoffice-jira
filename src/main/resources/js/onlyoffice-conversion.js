...
jQuery(function () {
    ...
    dialog.onContentReady(function() {
        ...
        submitButton.click(function (e) {
            ...
            var data = {
                "atl_token": form.find("#atl-token").val(),
                "id": form.find("#action-id").val(),
                "attachmentId": form.find("#attachment-id").val(),
                "actionType": form.find("#action-type").val(),
                "fileName": form.find("#file-name").val(),
                "targetFileType": form.find("#target-file-type").val()
